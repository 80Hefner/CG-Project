...
vector<Ponto> bezierTo3DFile(string patchFile, int tess_level) {
    string line;
    ifstream file;
...
int main(int argc, char** argv) {
    ...
    if (argc == 2 && strcmp(argv[1], "--help") == 0) {
        ...
        writePointsToFile(points, fileString);
    }
        ...
        points = sphere(radius, slices, stacks);
        ...
        points = torus(innerRadius, outerRadius, slices, stacks);
        ...
        points = bezierTo3DFile(patchFileString, tess_level);
        
        _3dFileString = _3DFILESFOLDER + _3dFileString;
        writePointsToFile(points, _3dFileString);
    }
